...
export const countrySettingsResponse2: UniRefund_SettingService_CountrySettings_CountrySettingDto =
  {
    isEnabled: true,
    groups: [
      {
...
export const countrySettingsResponse3: UniRefund_SettingService_CountrySettings_CountrySettingDto =
  {
    isEnabled: true,
    groups: [
      {
        ...
        items: [
          {
            ...
            bonds: [
              {
                key: "CountryManagement.IssuingFieldManagement.Passport.IsApplicable",
                pattern: "^false$",
                type: "DISABLES",
              },
            ],
            subItems: [
              {
                ...
                valueType: {
                  ...
                  validator: {
                    name: "BOOLEAN",
                    properties: { minValue: 0, maxValue: 0 },
                  },
                },
              },
              {
                ...
                depth: 1,
                description:
                  "CountryManagement.IssuingFieldManagement.Passport.IsApplicable.Description",
                displayName:
                  "CountryManagement.IssuingFieldManagement.Passport.IsApplicable.DisplayName",
                key: "CountryManagement.IssuingFieldManagement.Passport.IsApplicable",
                parentName: null,
                value: "true",
                defaultValue: "true",
