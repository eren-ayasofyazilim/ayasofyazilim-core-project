      ...
      resources: {
        ...
        AbpExceptionHandling: {
          texts: {
            ...
            DefaultErrorMessage404Detail:
              "İstenilen kaynak sunucuda bulunamadı.",
        ...
        AbpUi: {
          texts: {
            ...
            "PagerInfo{0}{1}{2}":
              "{2} kayıttan {0} ile {1} arası gösteriliyor.",
        ...
        AbpIdentity: {
          texts: {
            ...
            "DisplayName:Abp.Identity.Password.RequiredLength":
              "Uzunluk gerekli",
            ...
            "Description:Abp.Identity.ValidateEndpoints":
              "Uç Noktalarını Doğrula",
            "DisplayName:Abp.Identity.ValidateIssuerName":
              "Veren Adını Doğrula",
            "Description:Abp.Identity.ValidateIssuerName":
              "Veren Adını Doğrula",
            ...
            ClaimValue: "Değer",
            Date: "Tarih",
            ThereIsNoUsersCurrentlyInThisRole:
              "Bu rolde şu anda kullanıcı yok.",
            ...
            "Volo.Abp.Identity:010010":
              "Geçersiz harici oturum açma sağlayıcısı",
        ...
        AbpAccount: {
          texts: {
            ...
            "Volo.Account:InvalidTenantIdOrUserId":
              "Invalid TenantId or UserId!",
            ...
            "AuthorityDelegation:PleaseSelectUser":
            ...
            "DisplayName:IsSelfRegistrationEnabled":
              "Kendi kendine kayıt etkin",
            "Description:IsSelfRegistrationEnabled":
              "Kullanıcının hesabını kendi kendine kayıt edip edemeyeceğini belirtir",
            "DisplayName:IsRememberBrowserEnabled":
              "Tarayıcıyı hatırlama etkin",
            "Menu:Account": "Hesap",
            ...
            "TextTemplate:Abp.Account.EmailSecurityCode":
              "E-posta güvenlik kodu",
        ...
        AbpOpenIddict: {
          texts: {
            ...
            TheUserDetailsCannotBbeRetrieved:
              "Kullanıcı ayrıntıları alınamıyor.",
        ...
        Payment: {
          texts: {
            ...
            "Iyzico:EXCEEDS_ALLOWABLE_PIN_TRIES":
              "Maksimum PIN denemesi aşıldı.",
            ...
            "Iyzico:EXCEEDS_WITHDRAWAL_AMOUNT_LIMIT":
              "Para çekme limiti aşıldı.",
            ...
            "Iyzico:AMEX_CAN_USE_ONLY_MR":
              "American Express (AMEX) kart hatası.",
        ...
        Saas: {
          texts: {
            "Volo.Saas:DuplicateTenantName":
              "Müşteri ismi zaten mevcut: {Name}",
        ...
        LanguageManagement: {
          texts: {
            ...
            "Permission:LanguagesChangeDefault":
              "Varsayılan Dili Değiştirebilme",
